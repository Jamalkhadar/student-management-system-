...
94c42df wxn edit gareeyey readme aniga oo jooga master
d579699 waxan samaynay branch and dummy code
2424a45 waxaynu smaynay git ignore file
8536ba9 waxan dib usoo celinay file ka studentska
747742e wxan saarnay file studentska
a3111a6 waxan ku soo darnay ardayda mgcyadoodi
62cb325 Update readme with project description
...
git config --global user.name "name" → Used to set Git username
git config --global user.email "email" → Used to set Git email
...
git merge branch → Used to combine a branch into current branch
git log → Used to view full commit history
git log --oneline → Used to view short commit history
git diff → Used to see unstaged changes
git remote add origin URL → Used to connect project to GitHub
